...
public class Level3{
    ...
    public void level3(Stage primaryStage) {
        ...
        bird2.getImageView().setY(100*obj.getScale());
        ...
        setupMouseEvents(primaryStage, gameRoot, bird1ImageView, bird2ImageView);
    ...
    public void setupTextElements(Group gameRoot) {
        ...
        Text messageText1 = new Text("Level 3/6");
    ...
    public void handleKeyEvents(Scene scene, Stage primaryStage) {
        scene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER && levelFinished) {
                ...
                Level4 level4Game = new Level4();
                level4Game.level4(primaryStage);
            }
        });
    }
    ...
    public void setupMouseEvents(Stage primaryStage, Group gameRoot, ImageView bird1ImageView, ImageView bird2ImageView) {
        ...
        gameScene.setOnMouseClicked(event -> {
            ...
            if (!levelFinished && ammo==1)  {
                ...
                setupTextElements(gameRoot);
                obj1.playGunshotSound(obj.getVolume());
                ImageView[] birdImageViews = {bird1ImageView, bird2ImageView};
                ...
                for (ImageView birdImageView : birdImageViews) {
                    if (birdImageView.getBoundsInParent().contains(event.getX(), event.getY()))  {
                        ...
                        fallingBirdImageView.setScaleY(birdImageView.getScaleY());
