...
public class Level4{
    ...
    public void level4(Stage primaryStage) {
        ...
        Bird bird1 = new Bird(gameRoot, "assets/duck_red/", obj.getScale(), 1);
        Bird bird2 = new Bird(gameRoot, "assets/duck_red/", obj.getScale(), 1);
        ...
        setupMouseEvents(primaryStage, gameRoot, birdImageView1, birdImageView2);
    ...
    public void setupTextElements(Group gameRoot) {
        ...
        Text messageText1 = new Text("Level 4/6");
    ...
    public void handleKeyEvents(Scene scene, Stage primaryStage) {
        scene.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.ENTER && levelFinished) {
                ...
                Level5 level5Game = new Level5();
                level5Game.level5(primaryStage);
    ...
    public void setupMouseEvents(Stage primaryStage, Group gameRoot, ImageView birdImageView1, ImageView birdImageView2) {
        ...
        gameScene.setOnMouseClicked(event -> {
            ...
            if (!levelFinished && ammo==1)  {
                ...
                ImageView[] birdImageViews = {birdImageView1, birdImageView2};
